...
const CommonSignUp = (props) => {
    ...
    const onConfirmEyeClick = ()=>{
        setEyeOffConfirm(!eyeOffConfirm)
    }
        ...
        <View>
            ...
            <View style={{ flexDirection: 'column' }}>
                ...
                <View style={styles.textInputView}>
                    ...
                    />
                    <View style={{ marginRight: 20 }}>
                        <TouchableOpacity onPress={onConfirmEyeClick}>
                            <Feather
                                name={eyeOffConfirm ? 'eye-off' : 'eye'}
                                size={20}
                            />
                        </TouchableOpacity>
                    </View>
            ...
            <TouchableOpacity style={styles.buttonStyleSignUp} onPress={()=> props.navigation.goBack()}>
                <Text style={styles.textStyleSignUp}>Back to Sign In</Text>
            </TouchableOpacity>
        </View>
